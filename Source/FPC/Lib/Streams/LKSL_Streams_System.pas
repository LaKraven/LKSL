...
type
  ...
  generic StreamManager<T> = class abstract
  public type
    TArrayT = Array of T;
  public
    class procedure CustomDelete(const AStream: TStream; const ASizeOf: Int64); overload; inline;
    class procedure CustomDelete(const AStream: TStream; const APosition: Int64; const ASizeOf: Int64); overload; inline;
    class procedure CustomInsert(const AStream: TStream; const AValue: T; const ASizeOf: Int64); overload; inline;
    class procedure CustomInsert(const AStream: TStream; const AValue: T; const APosition: Int64; const ASizeOf: Int64); overload; inline;
    class function CustomRead(const AStream: TStream; const ASizeOf: Int64): T; overload; inline;
    class function CustomRead(const AStream: TStream; const APosition: Int64; const ASizeOf: Int64): T; overload; inline;
    class procedure CustomWrite(const AStream: TStream; const AValue: T; const ASizeOf: Int64); overload; inline;
    class procedure CustomWrite(const AStream: TStream; const AValue: T; const APosition: Int64; const ASizeOf: Int64); overload; inline;

    class procedure Delete(const AStream: TStream); overload; inline;
    class procedure Delete(const AStream: TStream; const APosition: Int64); overload; inline;
    class procedure DeleteArray(const AStream: TStream); overload; inline;
    class procedure DeleteArray(const AStream: TStream; const APosition: Int64); overload; inline;
    class procedure Insert(const AStream: TStream; const AValue: T); overload; inline;
    class procedure Insert(const AStream: TStream; const AValue: T; const APosition: Int64); overload; inline;
    class procedure InsertArray(const AStream: TStream; const AValues: Array of T); overload;
    class procedure InsertArray(const AStream: TStream; const AValues: Array of T; const APosition: Int64); overload;
    class function Read(const AStream: TStream): T; overload; inline;
    class function Read(const AStream: TStream; const APosition: Int64): T; overload; inline;
    class function ReadArray(const AStream: TStream): TArrayT; overload; inline;
    class function ReadArray(const AStream: TStream; const APosition: Int64): TArrayT; overload; inline;
    class procedure Write(const AStream: TStream; const AValue: T); overload; inline;
    class procedure Write(const AStream: TStream; const AValue: T; const APosition: Int64); overload; inline;
    class procedure WriteArray(const AStream: TStream; const AValues: TArrayT); overload;
    class procedure WriteArray(const AStream: TStream; const AValues: TArrayT; const APosition: Int64); overload;
  end;
...
var
  LStringLength: Int64;
begin
  LStringLength := Length(AValue) * SizeOf(Char);
  StreamMakeSpace(AStream, APosition, LStringLength);
  AStream.Write(LStringLength, SizeOf(Int64));
  AStream.Write(AValue[1], LStringLength);
end;
...
begin
  ...
  StreamMakeSpace(AStream, APosition, LStringLength);
  AStream.Write(LStringLength, SizeOf(Int64));
  AStream.Write(AValue[1], Length(AValue) * SizeOf(Char));
end;
{$ENDIF}
...
class procedure StreamManager.CustomDelete(const AStream: TStream; const ASizeOf: Int64);
begin
  StreamClearSpace(AStream, ASizeOf);
end;

class procedure StreamManager.CustomDelete(const AStream: TStream; const APosition: Int64; const ASizeOf: Int64);
begin
  AStream.Position := APosition;
  CustomDelete(AStream, ASizeOf);
end;

class procedure StreamManager.CustomInsert(const AStream: TStream; const AValue: T; const ASizeOf: Int64);
begin
  StreamMakeSpace(AStream, ASizeOf);
  AStream.Write(AValue, ASizeOf);
end;

class procedure StreamManager.CustomInsert(const AStream: TStream; const AValue: T; const APosition: Int64; const ASizeOf: Int64);
begin
  AStream.Position := APosition;
  CustomInsert(AStream, AValue, ASizeOf);
end;

class function StreamManager.CustomRead(const AStream: TStream; const ASizeOf: Int64): T;
begin
  AStream.Read(Result, ASizeOf);
end;

class function StreamManager.CustomRead(const AStream: TStream; const APosition: Int64; const ASizeOf: Int64): T;
begin
  AStream.Position := APosition;
  CustomRead(AStream, ASizeOf);
end;

class procedure StreamManager.CustomWrite(const AStream: TStream; const AValue: T; const ASizeOf: Int64);
begin
  CustomWrite(AStream, AValue, AStream.Size);
end;

class procedure StreamManager.CustomWrite(const AStream: TStream; const AValue: T; const APosition: Int64; const ASizeOf: Int64);
begin
  AStream.Position := APosition;
  AStream.Write(AValue, ASizeOf);
end;

class procedure StreamManager.Delete(const AStream: TStream);
begin
  Delete(AStream, AStream.Position);
end;

class procedure StreamManager.Delete(const AStream: TStream; const APosition: Int64);
begin
  StreamClearSpace(AStream, APosition, SizeOf(T));
end;

class procedure StreamManager.DeleteArray(const AStream: TStream);
var
  LStartPos: Int64;
  LLength, I: Integer;
begin
  LStartPos := AStream.Position;
  LLength := StreamReadInteger(AStream);
  AStream.Position := LStartPos;
  StreamDeleteInteger(AStream);
  for I := 0 to LLength - 1 do
    Delete(AStream);
end;

class procedure StreamManager.DeleteArray(const AStream: TStream; const APosition: Int64);
begin
  AStream.Position := APosition;
  DeleteArray(AStream);
end;

class procedure StreamManager.Insert(const AStream: TStream; const AValue: T);
begin
  StreamMakeSpace(AStream, SizeOf(T));
  AStream.Write(AValue, SizeOf(T));
end;

class procedure StreamManager.Insert(const AStream: TStream; const AValue: T; const APosition: Int64);
begin
  AStream.Position := APosition;
  Insert(AStream, AValue);
end;

class procedure StreamManager.InsertArray(const AStream: TStream; const AValues: array of T);
var
  I: Integer;
begin
  StreamInsertInteger(AStream, Length(AValues)); // Prefix Array Length
  for I := Low(AValues) to High(AValues) do // Insert Values in Sequence
    Insert(AStream, AValues[I]);
end;

class procedure StreamManager.InsertArray(const AStream: TStream; const AValues: array of T; const APosition: Int64);
begin
  AStream.Position := APosition;
  InsertArray(AStream, AValues);
end;

class function StreamManager.Read(const AStream: TStream): T;
begin
  AStream.Read(Result, SizeOf(T));
end;

class function StreamManager.Read(const AStream: TStream; const APosition: Int64): T;
begin
  AStream.Position := APosition;
  Result := Read(AStream);
end;

class function StreamManager.ReadArray(const AStream: TStream): TArrayT;
var
  LLength, I: Integer;
begin
  LLength := StreamReadInteger(AStream);
  ...
  for I := 0 to LLength - 1 do
    Result[I] := StreamManager.Read(AStream);
end;

class function StreamManager.ReadArray(const AStream: TStream; const APosition: Int64): TArrayT;
begin
  AStream.Position := APosition;
  Result := ReadArray(AStream);
end;

class procedure StreamManager.Write(const AStream: TStream; const AValue: T);
begin
  Write(AStream, AValue, AStream.Size);
end;

class procedure StreamManager.Write(const AStream: TStream; const AValue: T; const APosition: Int64);
begin
  AStream.Position := APosition;
  AStream.Write(AValue, SizeOf(T));
end;

class procedure StreamManager.WriteArray(const AStream: TStream; const AValues: TArrayT);
var
  I: Integer;
begin
  StreamWriteInteger(AStream, Length(AValues)); // Prefix Array Length
  for I := Low(AValues) to High(AValues) do // Write Values in Sequence
    Write(AStream, AValues[I]);
end;

class procedure StreamManager.WriteArray(const AStream: TStream; const AValues: TArrayT; const APosition: Int64);
begin
  AStream.Position := APosition;
  WriteArray(AStream, AValues);
end;
