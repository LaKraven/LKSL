...
type
  ...
  { Callback Types }
  TTestThreadTickCallback = procedure(const ADelta, AStartTime, ATickRate, ATickRateAverage, ATickRateAverageOver, ATickRateLimit: Double) of object;
...
begin
  ...
  Synchronize(procedure begin
                ...
                if Assigned(FOnTick) then
                  FOnTick(ADelta, AStartTime, TickRate, TickRateAverage, TickRateAverageOver, TickRateLimit);
                Unlock;
              end);
end;
